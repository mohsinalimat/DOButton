...
public class DOButton: UIButton {
    ...
    private func addTargets() {
        ...
        // add target
        //===============
        self.addTarget(self, action: #selector(DOButton.touchDown(_:)), forControlEvents: UIControlEvents.TouchDown)
        self.addTarget(self, action: #selector(DOButton.touchUpInside(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        self.addTarget(self, action: #selector(DOButton.touchDragExit(_:)), forControlEvents: UIControlEvents.TouchDragExit)
        self.addTarget(self, action: #selector(DOButton.touchDragEnter(_:)), forControlEvents: UIControlEvents.TouchDragEnter)
        self.addTarget(self, action: #selector(DOButton.touchCancel(_:)), forControlEvents: UIControlEvents.TouchCancel)
    }
