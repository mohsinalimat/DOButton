...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // star button
        let starButton = DOButton(frame: CGRect(x: x, y: y, width: 44, height: 44), image: UIImage(named: "star"))
        starButton.addTarget(self, action: #selector(ViewController.tappedButton(_:)), for: UIControlEvents.touchUpInside)
        self.view.addSubview(starButton)
        x += width
        
        // heart button
        let heartButton = DOButton(frame: CGRect(x: x, y: y, width: 44, height: 44), image: UIImage(named: "heart"))
        ...
        // like button
        let likeButton = DOButton(frame: CGRect(x: x, y: y, width: 44, height: 44), image: UIImage(named: "like"))
        ...
        // smile button
        let smileButton = DOButton(frame: CGRect(x: x, y: y, width: 44, height: 44), image: UIImage(named: "smile"))
    ...
    func tappedButton(_ sender: DOButton) {
